...
class Lex(Strategy):
    ...
    def check_exit(self):
        ...
        """
        research shows hard stop is ineffective
        duration capped at six days is most effective expiry
        USE POSITION SIZING TO REDUCE RISK
        ...
        if duration >= int(self.cfg.get('max_hold_period', 6)):
            alert = 'EXPIRY'
            get_out = True
